package me.mk3ext.dev.core.util.Decor;

import com.google.common.base.Preconditions;
import me.mk3ext.dev.core.Reflection.ServerPackage;
...
public class Title {
    ...
    public Title(String title, String subtitle, int fadeIn, int stay, int fadeOut) {
        this.title = convert(UtilColour.format(title));
        this.subtitle = convert(UtilColour.format(subtitle));
        this.fadeIn = fadeIn;
