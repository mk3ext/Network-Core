...
public class PunishCustomGUI {

    private static PunishCustomGUI ourInstance = new PunishCustomGUI();
    public static PunishCustomGUI getInstance() { return ourInstance;}
